      ...
      <Tabs defaultValue="hero" className="w-full">
                ...
                <Card key={slide.id} className="p-4 shadow-sm">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button variant="destructive" size="sm" onClick={() => toast({ title: "Bilgi", description: `Slayt ${slide.id} silinecek.` })}>
        ...
        <TabsContent value="kurulus">
          <Card>
            ...
            <CardFooter>
              <Button onClick={() => toast({ title: "Başarılı", description: "Kuruluş amacı kaydedildi." })}>
