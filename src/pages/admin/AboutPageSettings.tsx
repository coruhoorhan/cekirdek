          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                İstatistikler
                <Button size="sm" onClick={() => toast({ title: "Yeni istatistik ekleme formu açılacak." })}>
                ...
                <Card key={stat.id} className="p-4 shadow-sm">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-2">
                      <Button variant="outline" size="sm" onClick={() => toast({ title: `İstatistik ${stat.id} düzenlenecek.` })}>
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="destructive" size="sm" onClick={() => toast({ title: `İstatistik ${stat.id} silinecek.` })}>
        ...
        <TabsContent value="mission_vision">
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardFooter>
                <Button onClick={() => toast({ title: "Misyon kaydedildi: " + mission })}>
            ...
            <Card>
              ...
              <CardFooter>
                <Button onClick={() => toast({ title: "Vizyon kaydedildi: " + vision })}>
        ...
        <TabsContent value="principles">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                Eğitim İlkelerimiz
                <Button size="sm" onClick={() => toast({ title: "Yeni ilke ekleme formu açılacak." })}>
        ...
        <TabsContent value="timeline">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                Tarihçemiz
                <Button size="sm" onClick={() => toast({ title: "Yeni tarihçe öğesi ekleme formu açılacak." })}>
