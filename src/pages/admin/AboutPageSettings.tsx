                ...
                <Card key={stat.id} className="p-4 shadow-sm">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button variant="destructive" size="sm" onClick={() => toast({ title: "Bilgi", description: `İstatistik ${stat.id} silinecek.` })}>
        ...
        <TabsContent value="mission_vision">
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardFooter>
                <Button onClick={() => toast({ title: "Başarılı", description: "Misyon kaydedildi." })}>
            ...
            <Card>
              ...
              <CardFooter>
                <Button onClick={() => toast({ title: "Başarılı", description: "Vizyon kaydedildi." })}>
